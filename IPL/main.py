...
def scoreCard(match):
    ...
    MatchDT2.append(MatchDT[6].split(", ")[1])
    MatchDT2.append(num_suffix(MatchDT[2].day) + " " + MatchDT[2].strftime("%B %Y"))
    return render_template('scorecard.html', match=match, dt1=MatchDT, dt2=MatchDT2, dt3=MatchLDT, tid=teamID, dttm=dttm, sqf=SquadFull, find_player=find_player, fn=full_name)
